...
$result1=mysqli_query($conn, $sql1); //check for $conn variable
if (!$result1) {
...
$sql2 = "SELECT *
            ...
            WHERE iup.user_id=$user_id"; //wtf is $sql2 for!
...
$interested_properties = mysqli_fetch_all($result2, MYSQLI_ASSOC);//what does this do?!
?>
                        ...
                        <div class="content-container col-md-8">
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="button-container col-6">
                                    <a href="prp_detail.php?property_id=<?= $property['id'] ?>" class="btn btn-primary">View</a>
                                </div>
                            </div>
                        </div>
                    </div>
